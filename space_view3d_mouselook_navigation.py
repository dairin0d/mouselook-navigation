...
class MouselookNavigation(bpy.types.Operator):
    ...
    _transitions = ['NONE:ORBIT', 'NONE:PAN', 'ORBIT:FLY', 'ORBIT:FPS', 'PAN:DOLLY', 'PAN:ZOOM', 'DOLLY:ZOOM', 'FLY:FPS']
...
class MouselookNavigationRuntimeSettings(bpy.types.PropertyGroup):
    ...
    rotation_snap_autoperspective = bpy.props.BoolProperty(name="Orbit snap->ortho", default=False)
